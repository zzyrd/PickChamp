    ...
    <div class="container">
       ...
       <?php
        if($_SESSION['islogin']!='1')
				...
				?>
                <form action = "nfl_w15.php" method="POST" >
			<table class="table table-hover" width= "800" border ="2" cellpadding = "2" cellspacing = "2" >
			<br>NFL WEEK15<br>
			<br>Winner Picks<br>
			<br><img src="Logos/Buccaneers.png" width="200" height="200">Buccaneers<input type= 'radio' name= 'pick1' value = 'A' checked> <input type= 'radio' name= 'pick1' value = 'B' checked>Rams<img src="Logos/Rams.png" width="200" height="200"></br>
			<br><img src="Logos/Jets.png" width="200" height="200">Jets<input type= 'radio' name= 'pick2' value = 'A' checked> <input type= 'radio' name= 'pick2' value = 'B' checked>Cowboys<img src="Logos/Cowboys.png" width="200" height="200"></br>
			<br><img src="Logos/Chiefs.png" width="200" height="200">Chiefs<input type= 'radio' name= 'pick3' value = 'A' checked> <input type= 'radio' name= 'pick3' value = 'B' checked>Ravens<img src="Logos/Ravens.png" width="200" height="200"></br>
			<br><img src="Logos/Texans.png" width="200" height="200">Texans<input type= 'radio' name= 'pick4' value = 'A' checked> <input type= 'radio' name= 'pick4' value = 'B' checked>Colts<img src="Logos/Colts.png" width="200" height="200"></br>
			<br><img src="Logos/Bills.png" width="200" height="200">Bills<input type= 'radio' name= 'pick5' value = 'A' checked> <input type= 'radio' name= 'pick5' value = 'B' checked>Redskins<img src="Logos/Redskins.png" width="200" height="200"></br>
			<input class="btn btn-info" type="submit" name="submit" value = "submit">
             ...
             <?php
                ...
                if(isset($_POST['submit'])){
					...
					$sql = "INSERT INTO pick VALUES(DEFAULT, ?, 'NFL', '15', ?, ?, ?, ?, ?);";

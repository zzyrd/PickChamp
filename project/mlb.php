    ...
    <div class="container">
       ...
       <?php
        if($_SESSION['islogin']!='1')
				...
				?>
                <br>MLB PICKS</br>
			<br><a href="mlb_w10.php" class="btn btn-success">WEEK10</a></br>
			<br><a href="mlb_w11.php" class="btn btn-success">WEEK11</a></br>
			<br><a href="mlb_w12.php" class="btn btn-success">WEEK12</a></br>

    ...
    <div class="container">
       ...
       <?php
        if($_SESSION['islogin']!='1')
				...
				?>
             <form action = "nhl_w7.php" method="POST" >
			<table class="table table-hover" width= "800" border ="2" cellpadding = "2" cellspacing = "2" >
			<br>NHL WEEK7<br>
			<br>Winner Picks<br>
			<br><img src="Logos/Hurricanes.png" width="200" height="200">Hurricanes<input type= 'radio' name= 'pick1' value = 'A' checked> <input type= 'radio' name= 'pick1' value = 'B' checked>Blackhawks<img src="Logos/Blackhawks.png" width="200" height="200"></br>
			<br><img src="Logos/BlueJackets.png" width="200" height="200">BlueJackets<input type= 'radio' name= 'pick2' value = 'A' checked> <input type= 'radio' name= 'pick2' value = 'B' checked>Panthers<img src="Logos/Panthers_nhl.png" width="200" height="200"></br>
			<br><img src="Logos/Bruins.png" width="200" height="200">Bruins<input type= 'radio' name= 'pick3' value = 'A' checked> <input type= 'radio' name= 'pick3' value = 'B' checked>Senators<img src="Logos/Senators.png" width="200" height="200"></br>
			<br><img src="Logos/Coyotes.png" width="200" height="200">Coyotes<input type= 'radio' name= 'pick4' value = 'A' checked> <input type= 'radio' name= 'pick4' value = 'B' checked>Avalanche<img src="Logos/Avalanche.png" width="200" height="200"></br>
			<br><img src="Logos/Oilers.png" width="200" height="200">Oilers<input type= 'radio' name= 'pick5' value = 'A' checked> <input type= 'radio' name= 'pick5' value = 'B' checked>Flames<img src="Logos/Flames.png" width="200" height="200"></br>
            ...
            <?php
                ...
                if(isset($_POST['submit'])){
					...
					$sql = "INSERT INTO pick VALUES(DEFAULT, ?, 'NHL', '7', ?, ?, ?, ?, ?);";

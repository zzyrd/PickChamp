    ...
    <div class="container">
       ...
       <?php
        if($_SESSION['islogin']!='1')
				...
				?>
             <form action = "nhl_w6.php" method="POST" >
			<table class="table table-hover" width= "800" border ="2" cellpadding = "2" cellspacing = "2" >
			<br>NHL WEEK6<br>
			<br>Winner Picks<br>
			<br><img src="Logos/Panthers_nhl.png" width="200" height="200">Panthers<input type= 'radio' name= 'pick1' value = 'A' checked> <input type= 'radio' name= 'pick1' value = 'B' checked>Bruins<img src="Logos/Bruins.png" width="200" height="200"></br>
			<br><img src="Logos/Islanders.png" width="200" height="200">Islanders<input type= 'radio' name= 'pick2' value = 'A' checked> <input type= 'radio' name= 'pick2' value = 'B' checked>BlueJackets<img src="Logos/BlueJackets.png" width="200" height="200"></br>
			<br><img src="Logos/Capitals.png" width="200" height="200">Capitals<input type= 'radio' name= 'pick3' value = 'A' checked> <input type= 'radio' name= 'pick3' value = 'B' checked>Lightning<img src="Logos/Lightning.png" width="200" height="200"></br>
			<br><img src="Logos/Senators.png" width="200" height="200">Senators<input type= 'radio' name= 'pick4' value = 'A' checked> <input type= 'radio' name= 'pick4' value = 'B' checked>Canadiens<img src="Logos/Canadiens.png" width="200" height="200"></br>
			<br><img src="Logos/Stars.png" width="200" height="200">Stars<input type= 'radio' name= 'pick5' value = 'A' checked> <input type= 'radio' name= 'pick5' value = 'B' checked>Blues<img src="Logos/Blues.png" width="200" height="200"></br>

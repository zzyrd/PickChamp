    ...
    <div class="container">
       ...
       <?php
        if($_SESSION['islogin']!='1')
				...
				?>
             <form action = "nhl_w5.php" method="POST" >
			<table class="table table-hover" width= "800" border ="2" cellpadding = "2" cellspacing = "2" >
			<br>NHL WEEK5<br>
			<br>Winner Picks<br>
			<br><img src="Logos/Panthers_nhl.png" width="200" height="200">Panthers<input type= 'radio' name= 'pick1' value = 'A' checked> <input type= 'radio' name= 'pick1' value = 'B' checked>Penguins<img src="Logos/Penguins.png" width="200" height="200"></br>
			<br><img src="Logos/Bruins.png" width="200" height="200">Bruins<input type= 'radio' name= 'pick2' value = 'A' checked> <input type= 'radio' name= 'pick2' value = 'B' checked>Hurricanes<img src="Logos/Hurricanes.png" width="200" height="200"></br>
			<br><img src="Logos/Lightning.png" width="200" height="200">Lightning<input type= 'radio' name= 'pick3' value = 'A' checked> <input type= 'radio' name= 'pick3' value = 'B' checked>Capitals<img src="Logos/Capitals.png" width="200" height="200"></br>
			<br><img src="Logos/Sharks.png" width="200" height="200">Sharks<input type= 'radio' name= 'pick4' value = 'A' checked> <input type= 'radio' name= 'pick4' value = 'B' checked>Senators<img src="Logos/Senators.png" width="200" height="200"></br>
			<br><img src="Logos/Canucks.png" width="200" height="200">Canucks<input type= 'radio' name= 'pick5' value = 'A' checked> <input type= 'radio' name= 'pick5' value = 'B' checked>RedWings<img src="Logos/RedWings.png" width="200" height="200"></br>
                ...
                if(isset($_POST['submit'])){
					...
					echo $_POST['pick5'];
					 if($_POST['pick1'] == '' || $_POST['pick2'] == '' || $_POST['pick3'] == '' || $_POST['pick4'] == '' || $_POST['pick5'] == ''){
					   ...
					   $sql = "INSERT INTO pick VALUES(DEFAULT, ?, 'NHL', '6', ?, ?, ?, ?, ?);";
